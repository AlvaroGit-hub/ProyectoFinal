...
public class UserAuthPubKey{
  public static void main(String[] arg){
    ...
    try{
      ...
      chooser.setDialogTitle("C:\\Users\\CEINMARK\\Desktop\\Jorge-DAM\\pruebaclavepssh.ppk");
...
//			 , "passphrase"
      ...
      if(arg.length>0){
        ...
        host=JOptionPane.showInputDialog("pi",
                                         System.getProperty("pi")+
                                         "@localhost"); 
      }
      String user=host.substring(0, host.indexOf('@'));
      host=host.substring(host.indexOf('@')+1);

      Session session=jsch.getSession(user, host, 1022);
